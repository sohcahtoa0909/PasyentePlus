...
const IconSearch = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>;
...
const steps = [
  { icon: "⚙️", title: "Set Your Preferences", desc: "Tell us what matters — location, services, insurance, and more." },
  { icon: "📋", title: "Browse Results",        desc: "Explore a curated list of facilities ranked by your preferences." },
  { icon: "🔎", title: "View Details",           desc: "Dive into full facility profiles: hours, contacts, services." },
  { icon: "🚀", title: "Take Action",            desc: "Call, get directions, or save a facility directly from the app." },
];
  ...
  return (
    <div className="app-shell">
      ...
      <nav className="side-nav">
        ...
        <button className="nav-item" title="Search"><IconSearch /></button>
        ...
        <div className="nav-divider" />
        <button className="nav-item" title="Settings"><IconSettings /></button>
      </nav>
